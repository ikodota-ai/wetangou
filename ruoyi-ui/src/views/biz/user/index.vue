<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系统用户" align="center" prop="userName">
...
export default {
  ...
  methods: {
    ...
    buildParams() {
      ...
      p.params = { storeIds: this.queryParams.storeIds }
      delete p.storeIds
      return p
    },
    getList() {
      this.loading = true
      listUser(this.buildParams()).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除账号门店关联编号为"' + ids + '"的数据项？').then(function() {
        return delUser(ids)
      }).then(() => {
        this.getList()
